                ...
                <div className='col-lg-4 col-md-6'>
                    <div className='boilerCard'>
                        ...
                        <div className='boilerData'>
                            ...
                            <span className='prezzo'>1.350,00 €</span> <span className='prezzoPreSconto'>1.570,00 €</span><br />
                            <span className='note'>Sopralluogo e installazione inclusi</span><br />
                            <hr />
                            ...
                            <span className='confronta'>Confronta <input class="form-check-input" type="checkbox" value="" id="flexCheckDefault"></input></span>
                        </div>
                    </div>
                </div>
